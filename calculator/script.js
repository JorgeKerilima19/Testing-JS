class Calculator{
    constructor(previousOperandTextElementButtons, currentOperandTextElementButtons){
        this.currentOperandTextElement=currentOperandTextElementButtons;
        this.previousOperandTextElement=previousOperandTextElementButtons
        this.clear()
    }
    clear(){
        this.currentOperant="" 
    ...
    updateDisplay(){
        ...
        if(this.operation!=null){
            this.previousOperandTextElement.innerText=`${this.getDisplayNumber(this.previousOperant)} ${this,this.operation}`
        }else{
